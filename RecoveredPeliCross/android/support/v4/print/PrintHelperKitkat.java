...
class PrintHelperKitkat
{
    ...
    throws FileNotFoundException
  {
    ...
    //   0	241	0	this	PrintHelperKitkat
    //   0	241	1	paramUri	Uri
    //   0	241	2	paramInt	int
    //   32	20	3	localOptions1	BitmapFactory.Options
    //   49	59	5	i	int
    //   55	55	6	j	int
    //   76	16	7	k	int
    //   79	74	8	m	int
    //   124	82	9	localObject1	Object
    //   203	6	10	localObject2	Object
    //   161	8	11	localOptions2	BitmapFactory.Options
    //   211	20	12	localObject3	Object
    //   217	19	13	localObject4	Object
    //   233	6	14	localObject5	Object
    //   173	20	15	localBitmap	Bitmap
    //   179	19	16	localObject6	Object
    //   195	6	17	localObject7	Object
    // Exception table:
    //   from	to	target	type
    //   184	192	195	finally
    //   197	200	195	finally
